...
def main():
    ...
    hand_player = card.Hand(input('Please enter your name: '))
    hand_dealer = card.Hand('Dealer')


    #ask their starting balance
    chips_player = card.Chip()
    game.amount_check(chips_player)
    ...
    while round_on:
        ...
        game.amount_check(chips_player,round_num)
